<?php
add_action('wp_ajax_create_ajax_select','amp_acf_ajax_select_creator');
function amp_acf_ajax_select_creator($data = '', $saved_data= '', $current_number = '', $current_group_number= '') {
   ...
   // vars
    ...
    switch($options['param'])
    {
      case "post_type":
        ...
        $choices = amp_acf_post_type_generator();
      ...
      case "ef_taxonomy" :
        ...
        $choices = array('all' => esc_attr__('All','amp-acf'));
        $taxonomies = amp_acf_post_taxonomy_generator();
    ...
    // echo $saved_data;
      ...
      $output = '<select  class="widefat ajax-output" name="data_in_array[group-'.esc_attr($current_group_number).'][data_array]['. esc_attr($current_number) .'][key_3]">';

...
const withConfirmation = function (idPrefix, ModalContent, handleChangeCallback) {
  ...
  WrappedComponent => {
    class enhanceComponent extends external_this_wp_element_.Component {
      ...
      handleChange(event) {
        let changeValue = WrappedComponent.getChangeValue(event); // Process specific case for the template parts deletion confirmation.
...
/**
 * Checks if the given REST request is for the creation of a new template parts translation.
 *
 * @param {Object} options The initial request.
 * @returns {Boolean} True if the request concerns a template parts creation.
 */
...
/**
 * Use addIncludeUntranslatedParam if the given page is a template parts page.
...
/**
 * Returns true if the given post is a template parts, false otherwise.
 *
 * @param {Object} post A post object.
 * @returns {boolean} Whether it is a template parts or not.
 */
...
class LanguageItem extends external_this_wp_element_.Component {
  ...
  render() {
    ...
    }, (0,external_this_wp_i18n_.__)('This template parts is used for languages that have not yet been translated.', 'polylang-pro'))));
  }
...
/**
 * Handle the template parts translation creation when the "add" button is clicked.
...
DeleteButton.labelConfirmationModal = (0,external_this_wp_i18n_.__)('Delete template parts confirmation', 'polylang-pro');

const delete_button_ModalContent = _ref2 => {
  let {
    isDefaultLang
  } = _ref2;
  return (0,external_this_wp_element_.createElement)(external_this_wp_element_.Fragment, null, isDefaultLang && (0,external_this_wp_element_.createElement)("p", null, (0,external_this_wp_i18n_.__)('You are about to delete the template parts in the default language.', 'polylang-pro'), (0,external_this_wp_element_.createElement)("br", null), (0,external_this_wp_i18n_.__)('This will delete its customization and all its corresponding translations.', 'polylang-pro')), (0,external_this_wp_element_.createElement)("p", null, (0,external_this_wp_i18n_.__)('Are you sure you want to delete this template parts?', 'polylang-pro')));
};
...
if (isSiteBlockEditor()) {
   ...
   * and if the given URL is for a template or template parts list.
   *

...
function getCurrentLanguage(){
	...
	// Returns the default lang if the current location is a template parts list
...
/**
 * Adds the language suffix to a template parts only during creation.
 *
...
function maybeAddLangSuffixToTemplatePart( options, langSlug ){
	...
	if ( (0,external_lodash_.isUndefined)( restBaseUrl ) ) {
		// The user hasn't the rights to edit template parts.
		return;
	}

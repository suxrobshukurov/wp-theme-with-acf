...
class PLL_FSE_REST_Duplicate_Template extends PLL_FSE_Abstract_Module implements PLL_Module_Interface {
	...
	/**
	 * Translates template parts content on translation creation.
	 *
	 * @since 3.2
	 *
	 * @param WP_Post         $template The inserted or updated template parts.
	 * @param WP_REST_Request $request  The current request.
	 * @param bool            $creating True when creating a template parts, false when updating.
	 * @return void
	 */
	...
	/**
	 * Returns the slug of the template parts translation.
	 * Creates the translation if it does not exist.
	 *
	 * @since 3.2
	 *
	 * @param array<string> $attrs    {
	 *     string $slug  Template parts slug.
	 *     string $theme Template parts theme slug.
	 * }
	 * @param string        $language Slug language of the target post.
	 * @return string Slug of the translated template parts.
	 */
	public function translate_template_part( $attrs, $language ) {
		...
		// Check the content of the template parts to see if there is any block to translate.

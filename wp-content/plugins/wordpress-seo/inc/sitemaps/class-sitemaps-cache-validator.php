...
class WPSEO_Sitemaps_Cache_Validator {
	 ...
	 * @param string $prefix  The parts before the type in the cache key. Only the length is used.
	 * @param string $postfix The parts after the type in the cache key. Only the length is used.
	 *

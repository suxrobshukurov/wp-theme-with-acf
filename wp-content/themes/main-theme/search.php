...
$result_not_found = '<p class="ta-c py-30 fw-sb fs-u-sm-20">'.$searchData['not-found'].'</p>';
...
<main class="bg-s">
    <header class="mb-40 py-u-sm-60 py-u-sm-30 tc-w ta-c bg-pv">
        <h1 class="tc-w"><?= $searchData['title']?>: <?= get_query_var('s')?></h1>
    </header>
    <div class="container">
        <?php if($the_query->have_posts()) :?>
            ...
            <?php elseif (get_the_category()[0]->slug === 'casino'):
                $itemData = get_field('casino-data', $post->ID);
                $textDataCasino = get_field('casino-option-text', 'option');
                ?>
                <div class="col-o-xs-12 cl mb-25 ps-r br-10 bg-sv" data-casino-item>
                                ...
                                <div class="row-u-sm ai-u-sm-c mx-u-sm-n10">
                                    <div class="col-u-sm-auto px-u-sm-10">
                                        <figure class="br-6" style="background-color: <?=$itemData['bg']?>">
                                            <a href="<?= get_permalink($item)?>" class="cl__thumb foc p-20 of-h">
                                            <img width="86"
                                                 height="86"
                            ...
                            <div class="col-u-lg-8 col-o-md-7 col-o-sm col-o-xs-7 px-10">
                                <div class="row ai-u-sm-c f-o-xs-c mx-n10 fw-n h-o-xs-100">
                                    ...
                                    <div class="col-u-sm-4 px-10 ta-u-sm-c">
                                        ...
                                        <?php endif;?>
                                        <button class="cl__btn-mi w-100 py-10 tc-n td-u fs-14 js-lc-more loaded">
            ...
            <?php elseif (get_the_category()[0]->slug === 'slot'):
                $itemData = get_field('slot-data', $post->ID);
                    ?>

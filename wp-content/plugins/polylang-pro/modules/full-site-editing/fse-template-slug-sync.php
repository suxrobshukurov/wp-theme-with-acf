 ...
 * - The slug of the template in the default language is used as "base slug" (the parts before `___{language-code}`) for
 *   the templates in non-default languages within a translation group. This parts is synchronized among the group.
 *

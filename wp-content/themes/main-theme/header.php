    ...
    <div class="container">
        <div class="row mx-n5 ai-c jc-sb">
            <div class="col-auto px-5 order-u-md-1">
                <a href="<?= get_home_url();?>" class="header__logo d-f ai-c">
            ...
            <div class="col-auto d-f px-5 order-u-md-3">
                <button type="button" class="header__btn header__btn--search br-c bg-s ps-r js-search-header">
                ...
                <button type="button" class="header__btn header__btn--menu d-u-md-n br-c bg-s ps-r js-main-menu">

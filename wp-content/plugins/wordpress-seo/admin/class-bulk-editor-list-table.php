...
class WPSEO_Bulk_List_Table extends WP_List_Table {
	...
	/**
	 * Based on the page_type ($this->page_type) there will be constructed an url parts, for subpages and
	 * navigation.
	 *
	 * @var string
	 */
	 ...
	 *
	 * @param string $subquery         SQL FROM parts.
	 * @param string $all_states       SQL IN parts.
	 * @param string $post_type_clause SQL post type parts.
	 *
	 * @return mixed
	 */
	 ...
	 *
	 * @param array $post_ids Post IDs for SQL IN parts.
	 *
	 * @return mixed
	 */

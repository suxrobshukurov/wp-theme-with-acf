...
<style>
    ...
    .title__sub{max-width:690px}.c__arow:not(:last-child){margin-bottom:1px}.ch__box{border:2px solid rgba(255,255,255,.2)}.ch__thumb{min-height:176px}.ch__bb{background:rgba(255,255,255,.1)}.ch__icn{width:36px;height:36px}.ch__bf li{line-height:1.2;background:url(<?=ALFA_IMG_DIR?>/icons/check-benefits.svg) no-repeat 0 0}.ch__tc{color:rgba(255,255,255,.6);font-size:11px}.ch__tc a:hover{color:#fff}.cb a{color:inherit}.cb__ag{line-height:1.8571428571}.cb__ag li{background:url(<?=ALFA_IMG_DIR?>/icons/check-casino-boxes.svg) no-repeat 0 4px}.cb__ag li:not(:last-child){margin-bottom:7px}.cb__deag{line-height:1.8571428571}.cb__deag li{background:url(<?=ALFA_IMG_DIR?>/icons/uncheck-casino-boxes.svg) no-repeat 0 8px}.cb__deag li:not(:last-child){margin-bottom:7px}.cb__row:not(:last-child){border-bottom:1px solid rgba(35,34,34,.1)}.cb__flag{width:20px;height:15px}span.cb__flag.non-image {width: auto;}.cb__flag img:not(.lazyload):not(.lazyloading){position:absolute;top:0;left:-9999px;right:-9999px;bottom:0;margin:auto;max-width:none;width:auto;height:100%}.cb__pay{width:39px;height:26px}.cb__pay a{display:block;width:inherit;height:inherit}.cb__pay img{width:auto;max-height:100%}.cb__ck{margin-bottom:5px;line-height:1.8571428571;background:url(<?=ALFA_IMG_DIR?>/icons/check-casino-boxes.svg) no-repeat left 5px}.cb__uck{margin-bottom:5px;line-height:1.8571428571;background:url(<?=ALFA_IMG_DIR?>/icons/uncheck-casino-boxes.svg) no-repeat 2px 9px}.cb__tc{font-size:10px;line-height:1.3}.cb__tc a{color:var(--primary-variant)}@media (min-width: 992px){.c__athumb{width:40px;height:40px}.ch__thumb{width:274px}.cb__scr{max-height:158px}}@media (max-width: 991.98px){.c__athumb{width:50px;height:50px}}@media (min-width: 1230px){.ch__box .btn--p{width:264px}}@media (max-width: 767.98px){.ch__rating{position:absolute;top:30px;right:45px;z-index:5}.ch__wb{font-size:24px}}@media (min-width: 768px){.ch__wb{font-size:28px}}
</style>
<article class="of-h">
            ...
            <div class="container">
                <div class="breadcrumbs__list d-f f-w">
                    ...
                    <span property="itemListElement" typeof="ListItem">
                        <a property="item" typeof="WebPage" title="<?= bloginfo('name')?>" href="<?= get_home_url();?>" class="home">
                            ...
                            <div class="cb__row py-12 row ai-c ng">
                                ...
                                <?php if($item['value-type'] === 'link') :?>
                                    <?= not_empty($item['link']) && not_empty($item['link-text'])
                                        ? '<p class="col-auto"><a href="'.$item['link'].'" target="_blank" rel="nofollow"><strong class="fw-m pl-10" title="'.$item['link-text'] .'">'.$item['link-text']. '</strong></a></p>'
                                        :'';?>
                                ...
                                <?php foreach ($casinoData['providers'] as $item):?>
                                    <?php if(not_empty($item['text']) || not_empty($item['link'])):?>
                                        <div class="col-u-sm-4 pl-20 pr-u-sm-25 <?= $item['has-check'] ? 'cb__ck' : 'cb__uck';?>">
                                            <?php if($item['value-type'] === 'link') {
                                                echo '<a class="td-u" target="_blank" href="'. $item['link'].'" title="'.$item['link-text'].'">'.$item['link-text'].'</a>';
    ...
    <?php if(not_empty(get_the_content())):?>
        <div class="container">
            <div class="wp-editor mb-30"><?= amp_content()?></div>
        </div>
    <?php endif;?>

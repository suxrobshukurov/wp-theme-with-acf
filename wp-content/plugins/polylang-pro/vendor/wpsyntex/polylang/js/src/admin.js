		...
		*/
		...
		function parseSelectedLanguage( event ) {
			...
			return {
				...
				rtl: [values[2]],
				flag: values[3],
				name: selectedElement.text().split(' - ')[0] // At the moment there is no need of the 2nd parts because it corresponds on the locale which is already known by splitting the selected element value
			};
		}

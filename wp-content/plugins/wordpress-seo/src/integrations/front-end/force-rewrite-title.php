...
class Force_Rewrite_Title implements Integration_Interface {
	...
	/**
	 * Removes the title from the parts that contains the title and put this modified parts back
	 * into the content.
	 *
	 * @param string $part_with_title The parts with the title that needs to be replaced.
